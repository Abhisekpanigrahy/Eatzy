...
const styles = StyleSheet.create({
  ...
  nlTitle: { fontSize: 16, fontWeight: '900', color: '#1F2937', marginBottom: 2 },
  nlSub:   { fontSize: 13, color: '#6B7280', fontWeight: '500' },
  nlAction: {
    width: 32,
    height: 32,
    borderRadius: 16,
  ...
  nlArrow: { fontSize: 20, color: '#FF4C24', fontWeight: '800' },

  sectionTitle: { fontSize: 22, fontWeight: '900', color: '#1F2937', marginBottom: 16, marginTop: 4, letterSpacing: -0.5 },
  row:      { justifyContent: 'space-between' },
  cardWrap: { width: '48%', marginBottom: 16 },
  empty:    { textAlign: 'center', color: '#6B7280', fontSize: 15, marginTop: 24, fontWeight: '600' },
});
