...
const styles = StyleSheet.create({
  ...
  titleContent: { flex: 1 },
  name: { fontSize: 24, fontWeight: '900', color: '#1F2937', marginBottom: 4 },
  category: { fontSize: 14, fontWeight: '800', color: '#FF4C24', textTransform: 'uppercase' },
  ratingBadge: { backgroundColor: '#10B981', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12, alignItems: 'center' },
  ratingVal: { fontSize: 16, fontWeight: '900', color: '#fff' },
  ratingTotal: { fontSize: 10, color: 'rgba(255,255,255,0.85)', fontWeight: '600', marginTop: 2 },
  ...
  sectionTitle: { fontSize: 20, fontWeight: '900', color: '#1F2937', marginBottom: 12 },
  ...
  writeTitle: { fontSize: 15, fontWeight: '900', color: '#1F2937', marginBottom: 12 },
  ...
  submitBtnDisabled: { backgroundColor: '#fca5a5', elevation: 0 },
  ...
  reviewInfo: { flex: 1 },
  reviewUser: { fontSize: 15, fontWeight: '900', color: '#1F2937' },
  ...
  bottomPrice: { fontSize: 24, fontWeight: '900', color: '#1F2937' },
  ...
  qtyNum: { fontSize: 18, fontWeight: '900', color: '#1F2937' },
});
